...
document.getElementById("thumb1").addEventListener("click",imgSlide1)
 function imgSlide1(){
document.getElementById('mainImg').setAttribute("src","https://images.bewakoof.com/t540/teal-solid-mandarin-neck-long-kurta-437157-1637244552-1.jpg");
 }

 document.getElementById("thumb2").addEventListener("click",imgSlide2)
 function imgSlide2(){
document.getElementById('mainImg').setAttribute("src","https://images.bewakoof.com/t540/teal-solid-mandarin-neck-long-kurta-437157-1637244555-2.jpg");
 }

 document.getElementById("thumb3").addEventListener("click",imgSlide3)
 function imgSlide3(){
document.getElementById('mainImg').setAttribute("src","https://images.bewakoof.com/t540/teal-solid-mandarin-neck-long-kurta-437157-1637244559-3.jpg");
 }

 document.getElementById("thumb4").addEventListener("click",imgSlide4)
 function imgSlide4(){
document.getElementById('mainImg').setAttribute("src","https://images.bewakoof.com/t540/teal-solid-mandarin-neck-long-kurta-437157-1637244562-4.jpg");
 }

 document.getElementById("thumb5").addEventListener("click",imgSlide5)
 function imgSlide5(){
document.getElementById('mainImg').setAttribute("src","https://images.bewakoof.com/t540/teal-solid-mandarin-neck-long-kurta-437157-1637244566-5.jpg");
 }
